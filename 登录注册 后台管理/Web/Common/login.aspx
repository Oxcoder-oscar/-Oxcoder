 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="猿圈 登录.aspx.cs" Inherits="Web.Common.Login" %>
...
<body>
				...
				<section id="middle">
					...
					<div id="content" class="signin-page">
						...
						<div class="panel-group" id="signin-page">
							...
							<h3 class="panel-title" style="color: #fff;font-size: 2.4em;padding: 25px 25px 10px;text-shadow: 0 1px 2px rgba(0, 0, 0, 0.1);"><img src="../Public/Images/wlogo.png">猿圈登录</h3>
							<div class="panel panel-outline panel-no-padding" style="border: none;">
								<div id="signin" class="panel-collapse collapse in">
									<div class="panel-body col-md-6">
										<form runat="server" id="defaultForm" class="form-horizontal bv-form" novalidate="novalidate">
											...
											<div class="col-xs-12">
												<p><asp:Button class="btn btn-primary btn-lg" style="margin-left: 20px; border-radius: 3px;" runat="server" Text="登录" OnClick="btnLogin"></asp:Button></p>
											</div>
	...
	<footer class="col-md-12 footer-log">
		<div class="text-center">
			2016 oxcoder.com <a href="http://www.oxcoder.com/contact-us.action">联系我们</a> <a href="http://jq.qq.com/?_wv=1027&k=eeKvVb" target="_blank">QQ交流群:77590762</a>
